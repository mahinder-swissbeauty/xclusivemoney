...
const TokenizedText = ({ item }) => {
    if (typeof item === 'string') {
        ...
        return React.createElement(Text, { color: "blue" }, item.info);
    }
    else if ('warn' in item) {
        return React.createElement(Text, { color: "yellow" }, item.warn);
    }
    else if ('error' in item) {
        return React.createElement(Text, { color: "red" }, item.error);
    }
    else {
