...
import { relative, dirname as patheDirname, join, normalize, resolve, basename as basenamePathe, extname as extnamePathe, parse, isAbsolute, } from 'pathe';
 ...
 */
export function sanitizeRelativePath(input, warn) {
